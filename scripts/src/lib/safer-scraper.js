            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        if (!html.includes('Company Snapshot') || html.includes('Query Result')) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                try {
                    ...
                    console.error("Database update failed for ".concat(data.dot_number, ":"), error);
                }
                return [2 /*return*/];
            });
        });
        ...
        return __awaiter(this, arguments, void 0, function (limit) {
            ...
            return __generator(this, function (_a) {
                ...
                try {
                    ...
                    //   .select('dot_number')
                    //   .limit(limit)
                    return [2 /*return*/, []]; // carriers?.map(c => c.dot_number) || []
                }
                catch (error) {
