        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-6">
          <form onSubmit={handleSearch}>
            ...
            <div className="flex flex-wrap items-center gap-4 mb-6">
              ...
              {/* Carriers Only Toggle - Important Simple Feature */}
              <div className="flex items-center gap-2 px-3 py-2 bg-blue-50 border border-blue-200 rounded-md">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    ...
                    onChange={(e) => handleFilterChange({ ...filters, carriersOnly: e.target.checked })}
                ...
                <span className="text-xs text-gray-500 max-w-[120px]">
                  {filters.carriersOnly ? 'Motor carriers only' : 'All entity types'}
                </span>
              </div>
