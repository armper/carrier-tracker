...
export default function SmartDashboardLayout({ 
  ...
  const hasActiveFilters = filters.search || filters.riskLevel !== 'all' || filters.priority !== 'all' || 
                          filters.compliance !== 'all' || filters.tags.length > 0 || !filters.carriersOnly
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border p-4">
        ...
        {/* Carriers Only Toggle - Always Visible */}
          ...
          <div className="flex items-center justify-between">
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                onChange={(e) => updateFilters({ carriersOnly: e.target.checked })}
